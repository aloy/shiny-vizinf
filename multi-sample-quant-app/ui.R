  ...
  tabPanel(
    ...
    p(
      ...
      tags$ul(
        ...
        tags$li("Generate a lineup of stacked boxplots, density plots, or violin plots."),
    ...
    p(
      ...
      a difference in means/medians. After exploring the app, students should understand that identifying 
      ...
      Further, students should understand that variability exists when there is no difference,
    ...
    p(
      ...
      tags$ol(
        ...
        tags$li("Have students generate a lineup. Quickly explain that one panel displays
                ...
                under the assumption that no difference exists between the distributions.
